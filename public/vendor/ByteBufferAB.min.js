  ...
  function u(k) {
    ...
    g.concat = function (a, b, c, d) {
      ...
      for (n = 0; n < h; )
        ((c = a[n++]),
          ...
          0 >= e ||
            (d.set(
              new Uint8Array(c.buffer).subarray(c.offset, c.limit),
              b.offset,
            ),
            (b.offset += e)));
      b.limit = b.offset;
      ...
      if (a instanceof Uint8Array)
        ((b = new g(0, c, d)),
          0 < a.length &&
            ...
            (b.view = 0 < a.length ? new DataView(a.buffer) : null)));
    ...
    k &&
      ...
      (e.readInt64 = function (a) {
        ...
        a = this.littleEndian
          ? new k(this.view.getInt32(a, !0), this.view.getInt32(a + 4, !0), !1)
          : new k(this.view.getInt32(a + 4, !1), this.view.getInt32(a, !1), !1);
        b && (this.offset += 8);
        return a;
      }),
      ...
      (e.readUint64 = function (a) {
        ...
        a = this.littleEndian
          ? new k(this.view.getInt32(a, !0), this.view.getInt32(a + 4, !0), !0)
          : new k(this.view.getInt32(a + 4, !1), this.view.getInt32(a, !1), !0);
        b && (this.offset += 8);
        return a;
      }));
            ...
            ? ((d = (a >> 14) | 128),
              ...
              2097152 <= a
                ? ((d = (a >> 21) | 128),
                  ...
                  268435456 <= a
                    ? (this.view.setUint8(b + 4, (a >> 28) & 15), (d = 5))
                    : (this.view.setUint8(b + 3, d & 127), (d = 4)))
    ...
    e.prepend = function (a, b, c) {
      ...
      if (0 < f) {
        ...
        e = new Uint8Array(h);
        e.set(
          new Uint8Array(this.buffer).subarray(c, this.buffer.byteLength),
          b,
        );
        this.buffer = h;
        ...
        g: function (a, c) {
          ...
          for (var e, g, h, k; null !== (e = a()); )
            if (0 === (e & 128)) c(e);
              ...
              ((null !== (g = a()) && null !== (h = a())) || d([e, g, h]),
                c(((e & 15) << 12) | ((g & 63) << 6) | (h & 63)));
            else if (240 === (e & 248))
              ((null !== (g = a()) &&
                null !== (h = a()) &&
                null !== (k = a())) ||
