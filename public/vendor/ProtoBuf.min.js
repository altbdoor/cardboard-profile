...
(function (s) {
  function u(n) {
    var f = { VERSION: "4.0.0-pre", WIRE_TYPES: {} };
    ...
    f.Util = (function () {
      ...
      c.fetch = function (e, f) {
        ...
        if (c.IS_NODE)
          if (f)
            require("fs").readFile(e, function (d, a) {
              d ? f(null) : f("" + a);
            });
          else
            try {
          ...
          if (f)
            ((b.onreadystatechange = function () {
              4 == b.readyState &&
                (200 == b.status ||
                (0 == b.status && "string" === typeof b.responseText)
                  ? f(b.responseText)
                  : f(null));
            }),
    ...
    f.DotProto = (function (c, e) {
      ...
      q._readString = function () {
        ...
        if (null !== (d = e.STRING.exec(this.source)))
          return (
            (d = "undefined" !== typeof d[1] ? d[1] : d[2]),
            (this.index = e.STRING.lastIndex),
            this.stack.push(this.stringEndsWith),
            d
          );
        throw Error(
          "Unterminated string at line " + this.line + ", index " + this.index,
        );
      };
      q.next = function () {
        ...
        do {
          for (
            d = !1;
            e.WHITESPACE.test((a = this.source.charAt(this.index)));
        ...
        if (e.DELIM.test(this.source.charAt(d))) ++d;
          ...
          for (
            ++d;
            d < this.source.length && !e.DELIM.test(this.source.charAt(d));

          )
            d++;
        d = this.source.substring(this.index, (this.index = d));
        d === e.STRINGOPEN
          ? ((this.readingString = !0), (this.stringEndsWith = e.STRINGCLOSE))
          : d === e.STRINGOPEN_SQ &&
            ((this.readingString = !0),
            (this.stringEndsWith = e.STRINGCLOSE_SQ));
        return d;
      };
      q.peek = function () {
        ...
        for (
          ...
          switch (a) {
            case "package":
              ...
              break;
            case "import":
              if (!h) throw Error("Unexpected import at line " + this.tn.line);
            ...
            default:
              throw Error(
                "Unexpected token at line " + this.tn.line + ": " + a,
              );
          }
        delete d.name;
        return d;
      ...
      b._parseString = function () {
        ...
        do {
          ...
          if (a !== h)
            throw Error(
              "Illegal end of string at line " + this.tn.line + ": " + a,
            );
          a = this.tn.peek();
        } while (a === e.STRINGOPEN || a === e.STRINGOPEN_SQ);
        return d;
      };
      ...
      b._parsePackage = function (d) {
        ...
        if (!e.TYPEREF.test(d))
          throw Error(
            "Illegal package name at line " + this.tn.line + ": " + d,
          );
        var a = d;
        d = this.tn.next();
        if (d != e.END)
          throw Error(
            "Illegal end of package at line " + this.tn.line + ": " + d,
          );
        return a;
      };
      b._parseImport = function (d) {
        ...
        if (d !== e.STRINGOPEN && d !== e.STRINGOPEN_SQ)
          throw Error(
            "Illegal start of import at line " + this.tn.line + ": " + d,
          );
        var a = this._parseString();
        d = this.tn.next();
        if (d !== e.END)
          throw Error(
            "Illegal end of import at line " + this.tn.line + ": " + d,
          );
        return a;
      };
      ...
      b._parseIgnoredStatement = function (d, a) {
        var h;
        do {
          h = this.tn.next();
          if (null === h)
      ...
      b._parseService = function (d, a) {
        ...
        if (!e.NAME.test(a))
          throw Error(
            "Illegal service name at line " + this.tn.line + ": " + a,
          );
        var h = a,
          b = { name: h, rpc: {}, options: {} };
        a = this.tn.next();
        if (a !== e.OPEN)
          throw Error(
      ...
      b._parseServiceRPC = function (d, a) {
        ...
        var c = a,
          f = { request: null, response: null, options: {} };
        a = this.tn.next();
        if (a !== e.COPTOPEN)
          throw Error(
      ...
      b._parseMessage = function (d, a, b) {
        ...
        b === e.OPTOPEN &&
          a &&
          (this._parseFieldOptions(c, a, b), (b = this.tn.next()));
        if (b !== e.OPEN)
          throw Error(
            "Illegal start of " +
              (f ? "group" : "message") +
        ...
        do
          ...
          else if ("oneof" === b) this._parseMessageOneOf(c, b);
      ...
      b._parseMessageField = function (b, a) {
        ...
        if ("group" === a) {
          ...
          a = this.tn.next();
          a === e.OPTOPEN &&
            (this._parseFieldOptions(b, c, a), (a = this.tn.next()));
          if (a !== e.END)
            throw Error(
      ...
      b._parseMessageOneOf = function (b, a) {
        ...
        for (; this.tn.peek() !== e.CLOSE; )
          ((f = this._parseMessageField(b, "optional")),
            (f.oneof = c),
            k.push(f.id));
        this.tn.next();
        b.oneofs[c] = k;
      ...
      b._parseExtend = function (b, a) {
        ...
        if (!e.TYPEREF.test(a))
          throw Error(
            "Illegal message name at line " + this.tn.line + ": " + a,
          );
        var c = {};
        c.ref = a;
        c.fields = [];
    ...
    f.Reflect = (function (c) {
      ...
      b.resolve = function (a, b) {
        ...
        do {
          do {
            ...
            if (
              !(d && d instanceof l.T) ||
              (b && d instanceof l.Message.Field)
            ) {
              d = null;
              break;
            }
      ...
      b.build = function () {
        for (var a = {}, b = this.children, c = 0, e = b.length, f; c < e; ++c)
          ((f = b[c]), f instanceof d && (a[f.name] = f.build()));
      ...
      b.buildOpt = function () {
        for (
          var a = {}, b = Object.keys(this.options), c = 0, d = b.length;
          c < d;
          ++c
        )
      ...
      h.build = function (b) {
        ...
        b = (function (a, b) {
              ...
              if (0 < arguments.length)
                if (
                  ...
                  for (e = 0, p = arguments.length; e < p; ++e)
                    "undefined" !== typeof (f = arguments[e]) &&
                      this.$set(d[e].name, f);
                else this.$set(b);
            },
            ...
            e.oneof &&
              (null !== d
                ? (null !== this[e.oneof.name] &&
                    (this[this[e.oneof.name]] = null),
                  (this[e.oneof.name] = e.name))
                : e.oneof.name === c && (this[e.oneof.name] = null));
            return this;
          };
          p.$set = p.set;
          p.get = function (c, d) {
            ...
            if (!(m && m instanceof a.Reflect.Message.Field))
              throw Error(this + "#" + c + " is not a field: undefined");
            if (!(m instanceof a.Reflect.Message.Field))
              throw Error(
                this + "#" + c + " is not a field: " + m.toString(!0),
              );
            return this[m.name];
          };
          p.$get = p.get;
          for (var f = 0; f < d.length; f++) {
            var h = d[f];
            h instanceof a.Reflect.Message.ExtensionField ||
          ...
          Object.defineProperty &&
            (Object.defineProperty(e, "$options", { value: b.buildOpt() }),
            Object.defineProperty(p, "$options", { value: e.$options }),
            Object.defineProperty(e, "$type", { value: b }),
            Object.defineProperty(p, "$type", { value: b }));
          return e;
        })(c, this);
        this._fields = [];
        this._fieldsById = {};
        ...
        for (var d = 0, e = this.children.length, f; d < e; d++)
          if (((f = this.children[d]), f instanceof k)) b[f.name] = f.build();
      ...
      h.encode = function (a, b, c) {
        for (var d = null, e, f = 0, h = this._fields.length, g; f < h; ++f)
          ((e = this._fields[f]),
            ...
            e.required && null === g
              ? null === d && (d = e)
              : e.encode(c ? g : e.verifyValue(g), b));
        if (null !== d)
          throw (
            (a = Error(
      ...
      h.decode = function (a, b, d) {
        ...
        for (
          var f = a.offset, h = new this.clazz(), g, k, l;
          ...
          if ((g = this._fieldsById[l]))
            g.repeated && !g.options.packed
              ? h[g.name].push(g.decode(k, a))
              : ((h[g.name] = g.decode(k, a)),
                g.oneof &&
                  (null !== this[g.oneof.name] &&
                    (this[this[g.oneof.name]] = null),
                  (h[g.oneof.name] = g.name)));
          else
            switch (k) {
              case c.WIRE_TYPES.VARINT:
                a.readVarint32();
      ...
      h.verifyValue = function (a, b) {
        ...
        switch (this.type) {
          ...
          case c.TYPES.sfixed32:
            return (
              ("number" !== typeof a || (a === a && 0 !== a % 1)) &&
                d(typeof a, "not an integer"),
              4294967295 < a ? a | 0 : a
            );
          case c.TYPES.uint32:
          ...
          case c.TYPES["enum"]:
            ...
            for (e = 0; e < l.length; e++)
              if (l[e].name == a || l[e].id == a) return l[e].id;
      ...
      h.encodeValue = function (a, b) {
        ...
        switch (this.type) {
          ...
          case c.TYPES.bool:
            "string" === typeof a
              ? b.writeVarint32("false" === a.toLowerCase() ? 0 : !!a)
        ...
        try {
          if (this.repeated) {
            ...
            if (
              ...
              for (d = 0; d < a.length; d++)
                ((b += n.calculateVarint32(
                  (this.id << 3) | this.type.wireType,
                )),
                  (b += this.calculateValue(a[d])));
          } else
            ((b += n.calculateVarint32((this.id << 3) | this.type.wireType)),
        ...
        switch (this.type) {
          ...
          case c.TYPES.message:
            return (
              ...
              n.calculateVarint32(a) + a
            );
          case c.TYPES.group:
            return (
              (a = this.resolvedType.calculate(a)),
              a + n.calculateVarint32((this.id << 3) | c.WIRE_TYPES.ENDGROUP)
            );
        }
        throw Error(
          "[INTERNAL] Illegal value to encode in " +
      ...
      h.decode = function (a, b, d) {
        if (
          ...
          (d || a != c.WIRE_TYPES.LDELIM || !this.repeated)
        )
          throw Error(
        ...
        throw Error(
          "[INTERNAL] Illegal wire type for " + this.toString(!0) + ": " + a,
        );
      };
      l.Message.Field = r;
      ...
      (k.prototype = Object.create(d.prototype)).build = function () {
        for (
          var a = {}, b = this.getChildren(k.Value), c = 0, d = b.length;
          c < d;
          ++c
        )
          a[b[c].name] = b[c].id;
    ...
    f.Builder = (function (c, e, f) {
      ...
      q.define = function (b) {
        if ("string" !== typeof b || !e.TYPEREF.test(b))
        ...
        for (c = 0; c < b.length; c++)
          ((a = this.ptr.getChild(b[c])),
            null === a &&
              this.ptr.addChild((a = new f.Namespace(this, this.ptr, b[c]))),
            (this.ptr = a));
        return this;
      };
      ...
      l.isValidMessageField = function (b) {
        ...
        if ("undefined" !== typeof b.options) {
          ...
          for (var c = Object.keys(b.options), a = 0, f; a < c.length; a++)
            if (
              "string" !== typeof (f = c[a]) ||
              ("string" !== typeof b.options[f] &&
                "number" !== typeof b.options[f] &&
                "boolean" !== typeof b.options[f])
            )
              return !1;
        }
        return !0;
      ...
      l.isValidEnum = function (b) {
        if (
          ...
          !e.NAME.test(b.name) ||
          "undefined" === typeof b.values ||
          !c.Util.isArray(b.values) ||
          0 == b.values.length
        )
          return !1;
        for (var d = 0; d < b.values.length; d++)
          if (
            "object" != typeof b.values[d] ||
            "string" !== typeof b.values[d].name ||
            "undefined" === typeof b.values[d].id ||
            !e.NAME.test(b.values[d].name) ||
            !e.NEGID.test("" + b.values[d].id)
          )
            return !1;
        return !0;
      };
          ...
          if (c.Util.isArray(b))
            for (; 0 < b.length; ) {
              ...
              if (l.isValidMessage(a)) {
                ...
                if (a.oneofs)
                  for (
                    var k = Object.keys(a.oneofs), g = 0, n = k.length;
                    g < n;
                    ++g
                  )
                ...
                if (a.fields && 0 < a.fields.length)
                  for (g = 0, n = a.fields.length; g < n; ++g) {
                    ...
                    if (null !== e.getChild(k.id))
                      throw Error(
                        "Duplicate field id in message " + e.name + ": " + k.id,
                      );
                    if (k.options)
                      for (
                        var m = Object.keys(k.options), p = 0, s = m.length;
                        p < s;
                        ++p
                      ) {
                        ...
                        if (
                          "string" !== typeof k.options[m[p]] &&
                          "number" !== typeof k.options[m[p]] &&
                          "boolean" !== typeof k.options[m[p]]
                        )
                          throw Error(
                    ...
                    m = null;
                    if (
                      "string" === typeof k.oneof &&
                      ((m = q[k.oneof]), "undefined" === typeof m)
                    )
                      throw Error(
                ...
                a.extensions &&
                  ((e.extensions = a.extensions),
                  e.extensions[0] < c.ID_MIN && (e.extensions[0] = c.ID_MIN),
                  e.extensions[1] > c.ID_MAX && (e.extensions[1] = c.ID_MAX));
                this.ptr.addChild(e);
                ...
                for (g = 0; g < a.values.length; g++)
                  e.addChild(
                    new f.Enum.Value(this, e, a.values[g].name, a.values[g].id),
                  );
                this.ptr.addChild(e);
                ...
                if ((e = this.ptr.resolve(a.ref)))
                  for (g = 0; g < a.fields.length; g++) {
                    ...
                    if (
                      a.fields[g].id < e.extensions[0] ||
                      a.fields[g].id > e.extensions[1]
                    )
                      throw Error(
                        "Illegal extended field id in message " +
                          ...
                          a.fields[g].id +
                          " (" +
                          e.extensions.join(" to ") +
                          " expected)",
                      );
                    q = a.fields[g].name;
                    this.options.convertFieldsToCamelCase &&
                      (q = f.Message.Field._toCamelCase(a.fields[g].name));
                    k = new f.Message.ExtensionField(
                      this,
                      e,
                      a.fields[g].rule,
                      a.fields[g].type,
                  ...
                  if (!/\.?google\.protobuf\./.test(a.ref))
                    throw Error(
                      "Extended message " + a.ref + " is not defined",
                    );
                }
        ...
        if (b.imports && 0 < b.imports.length) {
          ...
          for (var k = 0; k < b.imports.length; k++)
            if ("string" === typeof b.imports[k]) {
              ...
              var g = b.imports[k];
              if (
                !/^google\/protobuf\//.test(g) &&
                ((g = a + e + g), !0 !== this.files[g])
              ) {
                /\.proto$/i.test(g) &&
                  !c.DotProto &&
                  (g = g.replace(/\.proto$/, ".json"));
        ...
        if (null != this.ptr && "object" !== typeof this.ptr.type) {
          if (this.ptr instanceof f.Namespace) {
            ...
            if (e.TYPE.test(this.ptr.type))
              ...
              b = (
                this.ptr instanceof f.Message.ExtensionField
            ...
            if (this.ptr instanceof c.Reflect.Service.Method)
              ...
              !(
                this.ptr instanceof c.Reflect.Message.OneOf ||
                this.ptr instanceof c.Reflect.Extension
              )
            )
              throw Error(
    ...
    f.loadProto = function (c, e, n) {
      if (
        "string" === typeof e ||
        (e && "string" === typeof e.file && "string" === typeof e.root)
      )
        ((n = e), (e = void 0));
    ...
    f.loadProtoFile = function (c, e, n) {
      ...
      if (e)
        return f.Util.fetch(
          "string" === typeof c ? c : c.root + "/" + c.file,
          function (l) {
    ...
    f.newBuilder = function (c) {
      ...
      "undefined" === typeof c.populateAccessors &&
